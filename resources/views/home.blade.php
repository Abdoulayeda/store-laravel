...
<body data-spy="scroll" data-target=".navbar" data-offset="90" style="background-color: #0c5460">
            ...
            <div class="row">
                <div class="col-12 col-lg-6 mt-auto mb-auto">
                    <ul class="d-flex mb-0 top-info">
                        <li class="c-links d-none d-lg-block"><span><i class="lab la-whatsapp"></i></span><a href="#">+221 78 277 71 40</a></li>
                    </ul>
                </div>
        ...
        <div class="row">
            <div class="col-12 text-center">
                <div class="heading-details mb-0">
                    <h4 class="heading">Nos Produits</h4>
                </div>
            </div>
            ...
            @foreach($produits as $produit)
                <div class="col-12 col-md-6 col-lg-4 text-center wow slideInUp">
                    <div class="featured-item-card">
                        <div class="item-img">
                            <img src="{{ asset('images/'.$proCFAduit->image )}}">
                        ...
                        <div class="item-detail">
                            ...
                            <p class="item-price">{{ $produit->prix }} F CFA</p>
                        </div>
                    </div>
                </div>
            @endforeach
